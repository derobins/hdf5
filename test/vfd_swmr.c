...
test_file_fapl(void)
{
    ...
    H5E_BEGIN_TRY { fid = H5Fcreate(FILENAME, H5F_ACC_TRUNC, H5P_DEFAULT, fapl1); }
    H5E_END_TRY;
    if (fid >= 0)
        TEST_ERROR;
    ...
    H5E_BEGIN_TRY { fid = H5Fcreate(FILENAME, H5F_ACC_TRUNC, fcpl, fapl1); }
    H5E_END_TRY;
    if (fid >= 0)
        TEST_ERROR;
    ...
    H5E_BEGIN_TRY { fid = H5Fopen(FILENAME, H5F_ACC_RDONLY, fapl1); }
    H5E_END_TRY;
    if (fid >= 0)
        TEST_ERROR;
    ...
    H5E_BEGIN_TRY { fid2 = H5Fopen(FILENAME, H5F_ACC_RDWR, fapl1); }
    H5E_END_TRY;
    if (fid2 >= 0)
        TEST_ERROR;
...
test_file_end_tick(void)
{
    ...
    H5E_BEGIN_TRY { ret = H5Fvfd_swmr_end_tick(fid1); }
    H5E_END_TRY;
    if (ret >= 0)
        TEST_ERROR;
    ...
    H5E_BEGIN_TRY { ret = H5Fvfd_swmr_end_tick(fid2); }
    H5E_END_TRY;
    if (ret >= 0)
        TEST_ERROR;
...
{
    struct timespec delay = {.tv_sec = tenths / 10, .tv_nsec = tenths * 100 * 1000 * 1000};
...
static unsigned test_disable_enable_eot_concur(void)
...
test_same_file_opens(void)
{
    ...
    H5E_BEGIN_TRY { fid2 = H5Fopen(FILENAME, H5F_ACC_RDONLY, fapl2); }
    H5E_END_TRY;
    if (fid2 >= 0)
        TEST_ERROR;
    ...
    H5E_BEGIN_TRY { fid2 = H5Fopen(FILENAME, H5F_ACC_RDONLY, H5P_DEFAULT); }
    H5E_END_TRY;
    if (fid2 >= 0)
        TEST_ERROR;
...
test_enable_disable_eot(void)
{
    ...
    H5E_BEGIN_TRY { ret = H5Fvfd_swmr_disable_end_of_tick(fid); }
    H5E_END_TRY;
    if (ret >= 0)
        TEST_ERROR
    ...
    H5E_BEGIN_TRY { ret = H5Fvfd_swmr_disable_end_of_tick(fid1); }
    H5E_END_TRY;
    if (ret >= 0)
        TEST_ERROR
    ...
    H5E_BEGIN_TRY { ret = H5Fvfd_swmr_enable_end_of_tick(fid2); }
    H5E_END_TRY;
    if (ret >= 0)
        TEST_ERROR
    ...
    H5E_BEGIN_TRY { ret = H5Fvfd_swmr_enable_end_of_tick(fid3); }
    H5E_END_TRY;
    if (ret >= 0)
        TEST_ERROR

    /* Should fail to disable file 3 */
    H5E_BEGIN_TRY { ret = H5Fvfd_swmr_disable_end_of_tick(fid3); }
    H5E_END_TRY;
    if (ret >= 0)
        TEST_ERROR
