...
static bool  H5D__chunk_is_partial_edge_chunk(unsigned dset_ndims, const uint32_t *chunk_dims,
                                                 const hsize_t *chunk_scaled, const hsize_t *dset_dims);
static void *   H5D__chunk_lock(const H5D_io_info_t *io_info, H5D_chunk_ud_t *udata, bool relax,
                                bool prev_unfilt_chunk);
static herr_t   H5D__chunk_unlock(const H5D_io_info_t *io_info, const H5D_chunk_ud_t *udata, bool dirty,
 ...
 */
htri_t
H5D__chunk_cacheable(const H5D_io_info_t *io_info, haddr_t caddr, bool write_op)
{
    const H5D_t *dataset     = io_info->dset; /* Local pointer to dataset info */
 ...
 */
static void *
H5D__chunk_lock(const H5D_io_info_t *io_info, H5D_chunk_ud_t *udata, bool relax, bool prev_unfilt_chunk)
{
 ...
 */
static herr_t
H5D__chunk_unlock(const H5D_io_info_t *io_info, const H5D_chunk_ud_t *udata, bool dirty, void *chunk,
                  uint32_t naccessed)
{
 ...
 */
herr_t
H5D__chunk_allocate(const H5D_io_info_t *io_info, bool full_overwrite, const hsize_t old_dim[])
{
