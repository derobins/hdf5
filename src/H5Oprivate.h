...
H5_DLL herr_t H5O_refresh_metadata_reopen(hid_t oid, H5G_loc_t *obj_loc, H5VL_t *vol_driver, bool start_swmr);
...
H5_DLL herr_t H5O_are_mdc_flushes_disabled(H5O_loc_t *oloc, bool *are_disabled);
