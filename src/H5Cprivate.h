...
H5_DLL herr_t H5C_get_cache_flush_in_progress(H5C_t *cache_ptr, bool *flush_in_progress_ptr);
...
H5_DLL herr_t H5C_image_stats(H5C_t *cache_ptr, bool print_header);
