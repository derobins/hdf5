 ...
 */
herr_t
H5VL_setup_name_args(hid_t loc_id, const char *name, const H5P_libclass_t *libclass, bool is_collective,
...
H5VL_setup_idx_args(hid_t loc_id, const char *name, H5_index_t idx_type, H5_iter_order_t order, hsize_t n,
                    const H5P_libclass_t *libclass, bool is_collective, hid_t acspl_id,
                    H5VL_object_t **vol_obj, H5VL_loc_params_t *loc_params)
{
    herr_t ret_value = SUCCEED; /* Return value */
