...
static herr_t H5FD_sec2_delete(const char *filename, hid_t fapl_id);
 ...
 */
static herr_t
H5FD_sec2_delete(const char *filename, hid_t H5_ATTR_UNUSED fapl_id)
{
    herr_t ret_value = SUCCEED;                 /* Return value             */
