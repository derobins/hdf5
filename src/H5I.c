 ...
 *              data structures and are not allocated dynamically later. FREE_FUNC is
...
H5Iregister_type2(unsigned reserved, H5I_free_t free_func)
{
    ...
    /* Delegate to the common type registration call */
    if (H5I_BADID == (ret_value = H5I__register_type_common(reserved, free_func)))
        HGOTO_ERROR(H5E_ID, H5E_CANTREGISTER, H5I_BADID, "Unable to register ID type");
